...
| A26e | Correction knows its limits | Repeat A26d with an Upper-Right stack (leaders exit left and descend) | No correction is attempted (both datum sides carry leader); log notes the corner is not verifiable for that mode |
